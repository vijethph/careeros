...
import profileSkill from "./agents/cv-skills/skills/profile-skill";
import evaluationSkill from "./agents/cv-skills/skills/evaluation-skill";
...
const agent = new LuaAgent({
  name: 'cv-skills', // Set during lua init
  persona: `# cv-skills - Persona
